...
public class Mago {
    ...
    //declaração dos atribuitos da classe
    private String nome;
    private int forca;
    ...
    public Mago(String nome, int forca, int destreza, int agilidade, int inteligencia, int carisma, int resistencia,
                int vida, int estamina, int sorte, int mana, Armadura armadura, Arma arma) {
        this.nome = nome;
        this.forca = forca;
